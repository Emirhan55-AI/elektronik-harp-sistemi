...
from app.strings.tr import PLOT_SPECTRUM, PLOT_FREQUENCY_LABEL, PLOT_POWER_LABEL
...
class SpectrumPlot(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self._plot_widget.getAxis("bottom").setPen(pg.mkPen(COLORS["text_secondary"], width=1))
        self._plot_widget.getAxis("left").setPen(pg.mkPen(COLORS["text_secondary"], width=1))
        self._plot_widget.getAxis("bottom").setTextPen(pg.mkPen(COLORS["text_secondary"]))
        self._plot_widget.getAxis("left").setTextPen(pg.mkPen(COLORS["text_secondary"]))
        self._plot_widget.getPlotItem().getViewBox().setBackgroundColor(QColor(COLORS["plot_bg"]))
        ...
        self._curve = self._plot_widget.plot(
            pen=pg.mkPen(COLORS["plot_line1"], width=2.2),
            name="Spektrum",
        )
        ...
        self._det_scatter = pg.ScatterPlotItem(
            size=6,
            pen=pg.mkPen(COLORS["plot_detection_marker"], width=1),
        ...
        self._confirmed_scatter = pg.ScatterPlotItem(
            size=12,
            pen=pg.mkPen(COLORS["plot_confirmed_marker"], width=2.4),
            brush=pg.mkBrush(COLORS["plot_confirmed_fill"]),
            symbol="o",  # Circle
            hoverable=True,
            hoverSymbol="star",
            hoverSize=18,
