...
1. `src/ehcore/algorithms/**` altinda yeni dosyani olustur.
...
3. AI'ye su bilgileri ver:
   ...
   - config alanlari
   - varsa spektrum/waterfall/tespit baglari
4. AI manifesti eklesin.
5. Sistem node'u palette ve runtime icinde gorunur hale getirir.

Istersen AI'ye vermeden once JSON spec'ten hizli kontrol de alabilirsin:
...
```text
Algoritma dosyasi: src/ehcore/algorithms/detection/my_detector.py
...
- [Algoritma Entegrasyon Rehberi](/Users/emirhan55/OneDrive/Desktop/Elektronik%20Harp/Sistem/docs/algoritma_entegrasyon_rehberi.md)
- [Manifest Taslak Olusturma](/Users/emirhan55/OneDrive/Desktop/Elektronik%20Harp/Sistem/docs/manifest_taslak_olusturma.md)
...
- plotting baglari
- issue/inspector/runtime entegrasyonu
- preset/recipe uyumlulugu

Yani hedef su:

- sen sadece algoritmayi yazarsin
- sistem geri kalan tum entegrasyonu tasir
